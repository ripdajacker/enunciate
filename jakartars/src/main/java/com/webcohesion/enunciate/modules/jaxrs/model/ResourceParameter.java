...
public class ResourceParameter extends DecoratedElement<Element> implements Comparable<ResourceParameter> {
  ...
  public static final List<String> FORM_BEAN_ANNOTATIONS = Arrays.asList("org.jboss.resteasy.annotations.Form", "jakarta.ws.rs.BeanParam", "com.sun.jersey.api.core.InjectParam");
